    ...
    <div class="cropper-box">
      ...
      <div class="footer-btn">
        ...
        <div class="upload-btn">
          <el-button size="mini"
                     type="success"
                     @click="uploadImg('blob')">上传封面 <i class="el-icon-upload"></i></el-button>
        </div>
      </div>
    </div>
    <!--预览效果图-->
    ...
    uploadImg (type) {
      ...
      if (type === 'blob') {
        ...
        this.$refs.cropper.getCropBlob(async (data) => {
          ...
          // let obj = { file: this.option.img }

          formData.append('images', this.option.img)
          let { data: res } = await upload(formData)
          if (res.code === 200) {
            _this.$message({
              message: res.msg,
              type: 'success'
